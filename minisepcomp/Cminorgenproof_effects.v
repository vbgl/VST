...
Lemma transl_step_correct:
  ...
  (exists T2 tm2, (exists TE, effstep_plus CMin_effsem tge TE T1 tm1 T2 tm2) /\ 
...
- (* skip seq *)
  ...
  + eexists; econstructor; split.
    eexists; apply effstep_plus_one. constructor. rewrite freshblock_irrefl', orb_false_r_ext.
    econstructor; eauto. 
  + eexists;econstructor; split.
    eexists; apply effstep_plus_one. constructor. rewrite freshblock_irrefl', orb_false_r_ext.
    eapply match_state_seq; eauto.
  + exploit IHMK; eauto. intros [T2 [tm2 [[TE A] B]]].
    exists T2; eexists; split. eexists; eapply effstep_one_plus_plus. constructor. eauto. reflexivity. 
    auto.
- (* skip block *)
  monadInv TR. left.
  dependent induction MK.
...
- (* skip call *)
  ...
  eexists; econstructor; split.
  eexists; eapply effstep_star_plus_trans'. eexact A. apply effstep_plus_one. apply estep_skip_call. auto. eauto. reflexivity.
...
- (* set *)
  ...
  eexists; apply effstep_plus_one. econstructor; eauto. 
...
- (* call *)
  ...
  left; eexists; econstructor; split.
  eexists; apply effstep_plus_one. eapply estep_call; eauto.
...
- (* ifthenelse *)
  ...
  eexists; apply effstep_plus_one. eapply estep_ifthenelse; eauto. eapply bool_of_val_inject; eauto.
...
- (* exit seq *)
  ...
  exploit IHMK; eauto. intros [T2 [tm2 [[TE A] B]]].
  exists T2; eexists; split. eexists; eapply effstep_one_plus_plus. constructor. eauto. reflexivity. eauto.
  exploit IHMK; eauto. intros [T2 [tm2 [[TE A] B]]].
  exists T2; eexists; split.
  eexists; eapply effstep_one_plus_plus. simpl. constructor. eauto. reflexivity.
  eauto. 
...
- (* exit block 0 *)
  ...
  eexists; eapply effstep_one_plus_plus. constructor. eauto. reflexivity. eauto. 

- (* exit block n+1 *)
  monadInv TR. left.
  dependent induction MK.
  eexists; econstructor; split.
  eexists; simpl. apply effstep_plus_one. constructor. rewrite freshblock_irrefl', orb_false_r_ext.
  econstructor; eauto. auto.
  exploit IHMK; eauto. intros [T2 [tm2 [[TE A] B]]].
  exists T2; eexists; split. 
  eexists; eapply effstep_one_plus_plus. constructor. eauto. reflexivity. auto. 
...
- (* switch *)
  ...
  + eexists; eapply effstep_plus_star_trans. eapply B.
...
- (* return none *)
  ...
  eexists; econstructor; split.
  eexists; apply effstep_plus_one. eapply estep_return_0. eauto.
...
- (* return some *)
  ...
  exploit match_callstack_freelist; eauto. intros [tm' [A [B C]]].
  eexists; econstructor; split.
  eexists; apply effstep_plus_one. eapply estep_return_1. eauto. eauto.
  erewrite freshblock_free_list, orb_false_r_ext; eauto.
  erewrite freshblock_free, orb_false_r_ext; eauto.
  econstructor; eauto. eapply match_call_cont; eauto.
...
- (* label *)
  ...
  eexists; apply effstep_plus_one. constructor.
...
- (* goto *)
  ...
  intros [ts' [tk' [xenv' [A [B C]]]]].
  left; econstructor; eexists; split.
  eexists; apply effstep_plus_one. apply estep_goto. eexact A.
  rewrite freshblock_irrefl', orb_false_r_ext. econstructor; eauto.
...
- (* internal call *)
  ...
  left; econstructor; eexists; split.
  eexists; apply effstep_plus_one. constructor; simpl; eauto.
...
- (* external call *)
  ...
  intros [f' [vres' [tm' [EC [VINJ [MINJ' [UNMAPPED [OUTOFREACH [INCR SEPARATED]]]]]]]]].
  left; econstructor; eexists; split.
  eexists; apply effstep_plus_one. econstructor. trivial.
  eapply external_call_symbols_preserved; eauto. apply senv_preserved.
  econstructor; eauto.
  eapply match_callstack_sub.
  { apply match_callstack_incr_bound with (Mem.nextblock m) (Mem.nextblock tm1).
...
- (* return *)
  inv MK. simpl.
  left; econstructor; eexists; split.
  eexists; apply effstep_plus_one. econstructor; eauto. rewrite freshblock_irrefl', orb_false_r_ext.
...
End TRANSLATION. (*CompCert 2.7.1 has 2233 lines, and 
  ...
  Cminorgen_locset has 2426 lines, so adding Effects has added 7 lines*)
