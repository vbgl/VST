...
- (* skip seq *)
  ...
  + eexists; econstructor; split.
    ...
    rewrite freshblock_irrefl', orb_false_r_ext.
    econstructor; eauto. 
  + eexists;econstructor; split.
    eexists; split. apply effstep_plus_one. constructor. discriminate. 
    rewrite freshblock_irrefl', orb_false_r_ext.
...
- (* store *)
  ...
  econstructor; eauto.
  erewrite freshblock_store, orb_false_r_ext; eauto.
  erewrite freshblock_store, orb_false_r_ext; eauto.
...
- (* goto *)
  ...
  intros [ts' [tk' [xenv' [A [B C]]]]].
  exists j; left; econstructor; eexists; split.
  eexists; split. apply effstep_plus_one. apply estep_goto. eexact A. discriminate.
  rewrite freshblock_irrefl', orb_false_r_ext. econstructor; eauto.
