...
Require Import Coqlib Maps AST minisepcomp.Registers minisepcomp.Op minisepcomp.RTL_memsem minisepcomp.Conventions.
...
Definition transf_function (f: function) : function :=
  ...
  then RTL_memsem.transf_function (transf_instr f) f
  else f.
