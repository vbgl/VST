...
Section Eff_INJ_SIMU_DIAGRAMS.
  ...
  Variable match_states: core_data -> meminj -> (block -> bool) -> C1 -> mem -> (block -> bool) -> C2 -> mem -> Prop.
  ...
  (* Hypothesis ginfo_preserved : (*gvar_infos_eq ge1 ge2 /\*) findsymbols_preserved ge1 ge2.*)
   ...
   Hypothesis match_validblocks : 
    forall d j L1 c1 m1 L2 c2 m2 (MS: match_states d j L1 c1 m1 L2 c2 m2),
   ...
   Hypothesis match_genv: forall d j L1 c1 m1 L2 c2 m2 (MC : match_states d j L1 c1 m1 L2 c2 m2),
   ...
   Hypothesis inj_initial_cores:  
    ...
    /\ match_states c1 j (fun b => false) c1 m1 (fun b => false) c2 m2.

  Hypothesis inj_halted :
    forall cd j L1 c1 m1 L2 c2 m2 v1,
    match_states cd j L1 c1 m1 L2 c2 m2 ->
...
Hypothesis order_wf: well_founded order.
  ...
  Hypothesis inj_after_external:
    forall cd j L1 st1 L2 st2 m1 e vals1 m2 efsig vals2 e' efsig'
      ...
      (MatchMu: match_states cd j L1 st1 m1 L2 st2 m2)
      ...
      forall j' ret1 m1' ret2 m2'
        ...
        exists st1', exists st2',
          ...
          match_states st1' j' L1 st1' m1' L2 st2' m2'.

  Hypothesis inj_effcore_diagram : 
    forall st1 m1 st1' m1' U1, 
    effstep Sem1 ge1 U1 st1 m1 st1' m1' ->
    forall st2 j m2 L1 L2,
    match_states st1 j L1 st1 m1 L2 st2 m2 ->
    exists st2', exists m2', exists j', exists L1', exists L2',
...
Proof.
  eapply Mini_simulation_inj.Build_Mini_simulation_inject with
    (core_ord := order)
    (match_state := fun d j L1 c1 m1 L2 c2 m2 => d = c1 /\ 
                     match_states d j L1 c1 m1 L2 c2 m2).
  apply order_wf.
...
clear - inj_effcore_diagram senvs_dom_eq.
  ...
  intros [c2' [m2' [j' [L1' [L2' [INC [GSEP [LAC [MC' [U2 [STEP' PROP]]]]]]]]]]]. 
  exists c2'. exists m2'. exists st1'. exists j', L1', L2'. 
...
+ clear - inj_effcore_diagram senvs_dom_eq. intros.
  exploit inj_effcore_diagram; try eassumption.
   intros [c2' [m2' [j' [L1' [L2' [INC [GSEP [LAC [MC' [U2 [STEP' PROP]]]]]]]]]]].
  exists c2'. exists m2'. exists j', L1', L2'. 
  split; try assumption.
  split; try assumption.
