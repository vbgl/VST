...
Require Import minisepcomp.Unityping.
Require Import Maps.
Require Import AST.
...
Require Import minisepcomp.RTL_memsem.
...
Inductive wt_stackframes: list stackframe -> signature -> Prop :=
  | wt_stackframes_nil: forall sg,
      (*compcomp: drop this side confition sg.(sig_res) = Some Tint ->*)
...
(*CompComp adaptation: state refactoring and elimianation of trace t 
  -- old statement was
...
Proof.*)
Lemma subject_reduction:
  forall st1 m1 st2 m2, step ge st1 m1 st2 m2 ->
  forall (WT: wt_state st1 m1), wt_state st2 m2.
Proof.
...
(*CompComp adaptation: TODO: maybe replacee by lemma about initcore
