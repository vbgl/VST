...
COQC=$(COQBIN)coqc -w -deprecated-focus,-deprecated-unfocus,-deprecated,-notation-overridden,-overriding-logical-loadpath
...
VERIC_FILES= \
  version.v base.v val_lemmas.v Memory.v shares.v splice.v rmaps.v rmaps_lemmas.v compcert_rmaps.v Cop2.v juicy_base.v type_induction.v composite_compute.v align_mem.v change_compspecs.v \
