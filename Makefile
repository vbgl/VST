...
VERIC_FILES= \
  base.v shares.v rmaps.v rmaps_lemmas.v kinds.v compcert_rmaps.v Cop2.v\
  ...
  slice.v res_predicates.v seplog.v assert_lemmas.v  ghost.v pcm.v \
...
PROGS_FILES= \
  ...
  merge.v verif_merge.v threadlib_ghost.v 
