...
Definition _len : ident := 32%positive.
...
Definition _ptr : ident := 31%positive.
...
((___builtin_fabs,
 ...
 (_memset,
   Gfun(External (EF_external _memset
     ...
     cc_default)) :: (_OPENSSL_cleanse, Gfun(Internal f_OPENSSL_cleanse)) ::
 nil);
prog_main := _main
|}.
